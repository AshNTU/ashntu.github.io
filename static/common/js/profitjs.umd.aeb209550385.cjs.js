...
<html lang="en">
  ...
  <link rel="canonical" href="https://octava.sg">

    
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="//fonts.googleapis.com/css2?family=Poppins:ital,wght@0,400;0,700;1,400;1,700&display=swap"
          rel="stylesheet">
    
    <link rel="stylesheet" href="/static/starter/static/css/theme.066f4b5de44c.css" />
  ...
  <nav aria-label="Top">
    ...
    <div x-data="{ isOpen: false }" @keydown.window.escape="isOpen = false">
        ...
        <div role="dialog"
            ...
            <!-- Slideover panel -->
            <div class="fixed inset-0 right-10 px-4 flex flex-col overflow-y-auto pb-4 bg-header"
                 x-show="isOpen"
            ...
            <div class="flex flex-col" x-data="{ subOpen: false }">
                <div class="flex flex-row px-6 py-3 transition border-r-4 border-navbar-link">
                        ...
                        <!-- Renders navigation folders -->
                            ...
                            <a class="min-w-max transition text-header"
                               href="/blog">Blog</a>
            ...
            <div class="flex flex-col" x-data="{ subOpen: false }">
                <div class="flex flex-row px-6 py-3 transition border-r-4 border-navbar-link">
                        ...
                        <!-- Renders navigation folders -->
                            ...
                            <a class="min-w-max transition text-header"
                               href="/c/our-investments">Our Investments</a>
            ...
            <div class="flex flex-col" x-data="{ subOpen: false }">
                <div class="flex flex-row px-6 py-3 transition border-r-4 border-navbar-link">
                        ...
                        <!-- Renders navigation folders -->
                            ...
                            <a class="min-w-max transition text-header"
                               href="/c/what-we-do">What we do</a>
    ...
    <div class="flex flex-col">
        ...
        <!-- Logo -->
        <a href="/"
           class="min-w-fit transition hover:opacity-75">
          <span class="sr-only">Octava</span>
          <img class="h-8 lg:h-12 w-auto"
               width="100"
               height="100"
               src="../../cdn.konigle.net/brand/1693962262/octava-logo.png"
               alt="Octava" />
        </a>
        <!-- Navbar links -->
        <div class="hidden lg:flex lg:flex-1 min-w-0 ml-4">
          <div class="flex flex-1 flex-row items-center min-w-0 gap-8 px-4">
              ...
              <!-- max 5 for lg+, max 7 for xl+ -->
                ...
                <div class="hidden min-w-0 text-ellipsis lg:flex xl:flex"
                     data-tile="link">
                  

    <div class="flex min-w-0" x-data="{ isOpen: false }">
        <div class="flex flex-row min-w-0 items-center">
            <a class="text-ellipsis overflow-hidden transition text-header"
               href="/">Octava Foundation</a>
    ...
    <div class="flex min-w-0" x-data="{ isOpen: false }">
        <div class="flex flex-row min-w-0 items-center">
            <a class="text-ellipsis overflow-hidden transition text-header"
               href="/c/our-investments">PORTFOLIO</a>
            <!-- Icon button to trigger dropdown modal, if there are sublinks -->
    ...
    <div class="flex min-w-0" x-data="{ isOpen: false }">
        ...
        <!-- Dropdown modal containing sublinks, if any -->
              ...
              <div class="flex justify-center items-center">
                <button class="transition text-header lg:hidden xl:hidden"
                        x-bind:class="linksOpen ? 'rotate-90' : 'rotate-0'"
                ...
                <!-- More links dropdown -->
                <div class="absolute top-full z-10 mt-2"
                     x-cloak
                     x-show="linksOpen"
    ...
    <div class="flex flex-col">
        ...
        <div class="flex flex-row flex-1 lg:flex-none justify-end items-center ml-4 lg:ml-8">
            ...
            <div class="flex pr-4 border-r border-header">
                ...
                <a href="/login"
                   class="btn btn-light-text btn-sm text-header">Login</a>
    ...
    <button type="submit"
        ...
        <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                    ...
                    <div class="sm:col-span-1 lg:col-span-3 overflow-auto grow px-4 sm:p-8 bg-gray-50 rounded-t-2xl sm:rounded-tr-none sm:rounded-bl-2xl"
...
<div class="relative mx-auto z-0">
        ...
        <a >
            <div class="slide relative z-0 transition duration-300 bg-black overflow-hidden">
                <img class="w-full z-0 object-center object-contain lg:object-cover max-h-[55vh] sm:max-h-[65vh] md:max-h-[70vh] lg:max-h-[75vh]"
                     src="../../cdn.konigle.net/carousel/1693962262/home-page-carousel-slide-1.jpg"
                     width=""
                     height=""
                     alt="Slide" />
        ...
        <a >
            <div class="slide relative z-0 transition duration-300 bg-black overflow-hidden">
                <img class="w-full z-0 object-center object-contain lg:object-cover max-h-[55vh] sm:max-h-[65vh] md:max-h-[70vh] lg:max-h-[75vh]"
                     src="../../cdn.konigle.net/carousel/1693962262/home-page-carousel-slide-2.jpg"
                     width=""
                     height=""
                     alt="Slide" />
                <div class="absolute bottom-4 lg:bottom-8 left-1/2 -translate-x-1/2 w-5/6 flex flex-col items-center text-center gap-y-4 lg:gap-y-8">
        ...
        <a >
            <div class="slide relative z-0 transition duration-300 bg-black overflow-hidden">
                <img class="w-full z-0 object-center object-contain lg:object-cover max-h-[55vh] sm:max-h-[65vh] md:max-h-[70vh] lg:max-h-[75vh]"
                     src="../../cdn.konigle.net/carousel/1693962262/home-page-carousel-slide-3.jpg"
                     width=""
                     height=""
                     alt="Slide" />
                <div class="absolute bottom-4 lg:bottom-8 left-1/2 -translate-x-1/2 w-5/6 flex flex-col items-center text-center gap-y-4 lg:gap-y-8">
        ...
        <a >
            <div class="slide relative z-0 transition duration-300 bg-black overflow-hidden">
                <img class="w-full z-0 object-center object-contain lg:object-cover max-h-[55vh] sm:max-h-[65vh] md:max-h-[70vh] lg:max-h-[75vh]"
                     src="../../cdn.konigle.net/carousel/1693962262/home-page-carousel-slide-4.jpg"
                     width=""
                     height=""
                     alt="Slide" />
                <div class="absolute bottom-4 lg:bottom-8 left-1/2 -translate-x-1/2 w-5/6 flex flex-col items-center text-center gap-y-4 lg:gap-y-8">
    ...
    <!-- The previous button -->
        ...
        <button class="absolute left-0 top-1/2 p-4 -translate-y-1/2 rounded-r-2xl transition text-white hover:text-black bg-black/75 hover:bg-white/75 cursor-pointer"
                aria-label="Previous"
                onclick="moveSlide(-1)">❮</button>
        <!-- The next button -->
        <button class="absolute right-0 top-1/2 p-4 -translate-y-1/2 rounded-l-2xl transition text-white hover:text-black bg-black/75 hover:bg-white/75 cursor-pointer"
                aria-label="Next"
                onclick="moveSlide(1)">❯</button>
    ...
    <h2 id="featured-blogs-heading"
        class="text-base mb-5 font-medium tracking-tight text-gray-500">Interesting reads</h2>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-8">
        
            
<article class="flex flex-col items-start justify-between">
  <a href="/blog/socially-responsible-investments"
     class="w-full rounded-2xl group transition  hover:bg-primary-content hover:drop-shadow-md hover:ring-1 hover:ring-gray-900/10 ">
    <div class="transition group-hover:scale-95">
      
        <div class="relative w-full">
          <img src="https://storage.googleapis.com/cdn.konigle.net/blogs/1693962262/202309/socially-responsible-investments-cover.jpeg?v=1695783641"
               alt="Socially Responsible Investments"
               width="1200"
               height="800"
               loading="lazy"
               class="aspect-[16/9] w-full rounded-xl bg-gray-100 object-cover sm:aspect-[2/1] lg:aspect-[3/2] ring-1 ring-gray-900/10" />
        </div>
...
<article class="flex flex-col items-start justify-between">
  <a href="/blog/what-is-impact-investing"
     class="w-full rounded-2xl group transition  hover:opacity-75 ">
...
<article class="flex flex-col items-start justify-between">
  <a href="/blog/generative-ai-use-cases-for-impact-investing"
     class="w-full rounded-2xl group transition  hover:opacity-75 ">
    <div class="transition ">
    ...
    <h3 class="bg-red-600 px-4 py-2 text-md rounded-md text-white drop-shadow-md fixed top-4 right-4  hidden -translate-y-32 transition ease-in-out duration-500 max-w-md"
        id="message-error"></h3>
    <div id="profitjs"></div>
    <div>
  ...
  <ul class=" grid grid-flow-row grid-cols-2 grid-rows-3 gap-3 md:grid-cols-3 lg:grid-cols-4">
      ...
      <li>
        <a href="/pages/about"
           ...
           class="text-sm leading-6 hover:underline">About Us</a>
      </li>
    
      <li>
        <a href="/pages/contact"
           data-footer-nav-link=""
           class="text-sm leading-6 hover:underline">Contact Us</a>
      </li>
    
      <li>
        <a href="/pages/our-story"
           data-footer-nav-link=""
           class="text-sm leading-6 hover:underline">Our Story</a>
      </li>
    
      <li>
        <a href="/pages/privacy"
           data-footer-nav-link=""
           class="text-sm leading-6 hover:underline">Privacy Policy</a>
      </li>
      ...
      <li>
          ...
          <a href="/blog"
             data-footer-nav-link=""
             class="text-sm leading-6 text-gray-600 hover:text-gray-900 hover:underline">Blog</a>
      ...
      <li>
          ...
          <a href="/c/glossary"
             data-footer-nav-link=""
             class="text-sm leading-6 text-gray-600 hover:text-gray-900 hover:underline">Glossary</a>
      ...
      <li>
          ...
          <a href="/c/library"
             data-footer-nav-link=""
             class="text-sm leading-6 text-gray-600 hover:text-gray-900 hover:underline">Library</a>
        
      </li>
    
      <li>
        
          <a href="/c/our-investments"
             data-footer-nav-link=""
             class="text-sm leading-6 text-gray-600 hover:text-gray-900 hover:underline">Our Investments</a>
      ...
      <li>
          ...
          <a href="/c/what-we-do"
             data-footer-nav-link=""
             class="text-sm leading-6 text-gray-600 hover:text-gray-900 hover:underline">What we do</a>
    ...
    <li>
      <a href="/help"
         data-footer-nav-link=""
         class="text-sm leading-6 hover:underline">Help</a>
    </li>
  </ul>
</nav>
</div>
    ...
    <p class="mt-2 text-center text-xs leading-5 text-gray-600"
       id="copyright-notice">© 2023 Octava. All rights reserved.</p>
    <a target="_blank"
       id="powered-by-konigle"
       class="mt-2 mx-auto text-center text-xs leading-5 text-blue-700 flex items-center justify-center"
       href="https://konigle.com?referrer=octava.sg">
      <svg xmlns="http://www.w3.org/2000/svg"
           fill="none"
           viewBox="0 0 24 24"
           stroke-width="1.5"
...
<script src="/static/common/js/profitjs.umd.aeb209550385.cjs"
        defer
...
<!--
     FILE ARCHIVED ON 09:27:34 Nov 21, 2023 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 10:39:49 Nov 21, 2023.
...
<!--
playback timings (ms):
  captures_list: 135.649
  exclusion.robots: 0.159
  exclusion.robots.policy: 0.117
  cdx.remote: 0.069
  esindex: 0.009
  LoadShardBlock: 106.887 (3)
  PetaboxLoader3.datanode: 50.567 (3)
  PetaboxLoader3.resolve: 53.429 (2)
  load_resource: 35.123
-->