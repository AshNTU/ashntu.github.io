...
<div class="relative mx-auto z-0">
        ...
        <a >
            <div class="slide relative z-0 transition duration-300 bg-black overflow-hidden">
                <img class="w-full z-0 object-center object-contain lg:object-cover max-h-[55vh] sm:max-h-[65vh] md:max-h-[70vh] lg:max-h-[75vh]"
                     src="https://storage.googleapis.com/cdn.konigle.net/carousel/1693962262/home-page-carousel-slide-3.jpg"
                     width=""
                     height=""
                     alt="Slide" />
                <div class="absolute bottom-4 lg:bottom-8 left-1/2 -translate-x-1/2 w-5/6 flex flex-col items-center text-center gap-y-4 lg:gap-y-8">
...
<!--
     FILE ARCHIVED ON 03:47:18 Nov 21, 2023 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 08:49:47 Nov 21, 2023.
...
<!--
playback timings (ms):
  captures_list: 201.807
  exclusion.robots: 0.063
  exclusion.robots.policy: 0.055
  cdx.remote: 0.049
  esindex: 0.009
  LoadShardBlock: 110.579 (3)
  PetaboxLoader3.datanode: 132.333 (4)
  load_resource: 39.206
-->